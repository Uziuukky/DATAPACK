...
execute as @a[scores={vampire=1..},nbt={SelectedItem:{tag:{Vam:1b}}}] at @s run tag @e[sort=random,limit=1,distance=0.001..5] add victim.vampire
...
execute as @a[scores={vampire=1..},nbt={SelectedItem:{tag:{Vam:1b}}}] at @s run scoreboardply
